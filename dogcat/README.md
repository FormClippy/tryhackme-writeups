...
### 🧪 2.2 ใช้ php://filter เพื่อดู Source Code เพื่อดู Source Code
...
### 💉 2.8 วาง PHP Payload ผ่าน User-Agent (Log Poisoning)
...
### 🧫 2.9 เรียกใช้ Webshell ผ่าน LFI เพื่อทดสอบคำสั่ง whoami
...
### 🐚 2.10 เตรียม Reverse Shell ด้วย PHP
...
### 🧬 2.11 แปลง Payload ให้พร้อมฝังลง Log
...
### 🧨 2.12 ฝัง Payload และรอรับ Reverse Shell
...
### 🔓 2.15 Privilege Escalation สู่ root สู่ root
