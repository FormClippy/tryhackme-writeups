...
```
**อธิบายคำสั่ง:**
sqlmap คือเครื่องมืออัตโนมัติที่ใช้สำหรับตรวจสอบช่องโหว่ SQL Injection และช่วยดึงข้อมูลฐานข้อมูลออกมา

-u "http://10.10.28.30/products/3*" ระบุ URL ที่ต้องการทดสอบ โดยใช้ 3* เป็น wildcard ให้ sqlmap ลองค่า id หลาย ๆ ค่า เพื่อหาจุดที่ช่องโหว่อาจเกิดขึ้น

--dbs เป็นคำสั่งให้ sqlmap ดึงชื่อฐานข้อมูลทั้งหมดที่เชื่อมต่อกับเว็บเป้าหมาย
