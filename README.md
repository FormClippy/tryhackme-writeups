...
# 📌
> ทีนี้ให้เราพิจารณาว่าอาจมี SQL หรือฐานข้อมูลบางส่วนที่ backend ซึ่งเราดึงข้อมูลนี้มาใช้ฐานข้อมูลนั้นเพื่อดึงข้อมูลนั้นเป็น key หลัก
...
- ให้เราเลื่อนลงมาล่างสุดจะเจอกับชื่อฐานข้อมูล โดยจะมี duckyinc, information_schme, mysql, performance_scheme, sys
- และแน่นอนว่า 4 อันล่างสุดมันคือค่าเริ่มต้นในฐานข้อมูล Mysql ดังนั้นเราจะโฟกัสไปที่ duckyinc
