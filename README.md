...
โจทย์ต้องการให้เราเจาะเข้าเว็บเซิร์ฟเวอร์ที่รันเว็บไซต์ และทำการเปลี่ยนแปลงหน้าแรกของเว็บ (deface) เพื่อแสดงว่าเราเข้าถึงระบบได้

---

## 🛰️ 1. ข้อมูลเบื้องต้น (Target Info)

- IP เป้าหมาย: 10.10.28.30  
- พอร์ตที่เปิด: 22 (SSH), 80 (HTTP)
