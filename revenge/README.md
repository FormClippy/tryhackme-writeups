...
- [🛰️ 1. ข้อมูลเบื้องต้น (Target Info)](#1-ข้อมูลเบื้องต้น-target-info)
- [🌐 2. ทดลองเข้าใช้งานเว็บไซต์](#ทดลองเขาใชงานเวบไซต)
...
- [🔐 4. SSH เข้าเครื่องเป้าหมาย](#ssh-เขาเครองเปาหมาย)
- [📁 5. ค้นหา Flag](#คนหา-flag)
...
- [🌐 7. แก้ไขหน้าเว็บ `(#แกไขหนาเวบ-(deface))`](#แกไขหนาเวบ-(deface))
...
- [🏁 8. ค้นหา Flag สุดท้าย (#คนหา-flag-สดทาย-(flag3txt))](#คนหา-flag-สดทาย-(flag3txt))
---
...
## 1. ข้อมูลเบื้องต้น (Target Info) 🛰️
